...
public class CustomQueue<T> extends AbstractCustomQueueAdapter<T> {
	...
	/**
	 * Retrieves and removes the head of queue, or returns null if this queue is
	 * empty.
	 * 
	...
	/**
	 * Retrieves, but does not remove, the head of queue, or returns null if
	 * this queue is empty.
	 * 
	 * @return first object in queue or null if queue is empty
	 */
